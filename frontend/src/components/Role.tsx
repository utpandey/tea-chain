...
const Role: FC<IRoleProps> = ({ data,index }) => {
  ...
  return (
    <div className="admin__cont__horizCont__item">
      ...
      <h1 className="admin__cont__horizCont__item__title">Harvesting Date: <span>{(new Date(parseInt(data[5]._hex, 16)).toISOString()).slice(0,10)}</span></h1>
      ...
      <h1 className="admin__cont__horizCont__item__title">Receiving Date: <span>{(new Date(parseInt(data[4]._hex, 16)).toISOString()).slice(0,10)}</span></h1>
      <h1 className="admin__cont__horizCont__item__title">Withering Duration: {parseInt(data[5]._hex, 16)}</h1>
      </>) : (<>
      ...
      <h1 className="admin__cont__horizCont__item__title">Receiving Date: <span>{(new Date(parseInt(data[3]._hex, 16)).toISOString()).slice(0,10)}</span></h1>
      </>): (<>
      ...
      <h1 className="admin__cont__horizCont__item__title">WalletAddress: {data[1]}</h1>
        ...
        <h1 className="admin__cont__horizCont__item__title">Receiving Date: <span>{(new Date(parseInt(data[3]._hex, 16)).toISOString()).slice(0,10)}</span></h1>
      <h1 className="admin__cont__horizCont__item__title">Storage Temperature: {data[4]}°C</h1>
      </>): (<>
