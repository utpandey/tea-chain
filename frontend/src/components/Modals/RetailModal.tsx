...
export const RetailModal: FC<IModalProps> = ({ showModal, setModal, fetchTeachain,loading, setLoading, setError }) => {
	...
	async function setTeachain(event: React.FormEvent) {
		...
		if (typeof window.ethereum !== 'undefined') {
			...
			contract.on('BatchCreated', async (res) => {
				...
				const transactionTwo = await contract.functions.updateRetailerEntry(
					batchId,
					address,
					name,
					newDate.getTime(),
